...
db_migrate:
	${DOCKER_COMPOSE} exec -u www-data php bin/console doctrine:migrations:migrate --no-interaction
db_diff:
	${DOCKER_COMPOSE} exec -u www-data php bin/console doctrine:migrations:diff --no-interaction
